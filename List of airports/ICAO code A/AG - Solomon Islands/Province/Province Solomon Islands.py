...
# Extraire uniquement la colonne "Province"
Province = df['Province']

# Enregistrer la colonne "Province" dans un fichier CSV
csv_file_path = 'Province Solomon islands.csv'
Province.to_csv(csv_file_path, index=False, header=['Province'])
